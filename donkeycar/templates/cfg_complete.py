...
MM1_SHOW_STEERING_VALUE = False
	# Serial port
#                    -- Jetson Nano: '/dev/ttyTHS1'	# -- Default Pi: '/dev/ttyS0'
#                    -- Google coral: '/dev/ttymxc0'	# -- Jetson Nano: '/dev/ttyTHS1'
#                    -- Windows: 'COM3', Arduino: '/dev/ttyACM0'	# -- Google coral: '/dev/ttymxc0'
#                    -- MacOS/Linux:please use 'ls /dev/tty.*' to find the correct serial port for mm1 	# -- Windows: 'COM3', Arduino: '/dev/ttyACM0'
#                       eg.'/dev/tty.usbmodemXXXXXX' and replace the port accordingly	# -- MacOS/Linux:please use 'ls /dev/tty.*' to find the correct serial port for mm1
